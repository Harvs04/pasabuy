            ...
            <div class="h-fit bg-white rounded-lg shadow-md px-5 pt-5 pb-5 mid:pb-0 flex flex-col lg:gap-0">
                ...
                <div class="flex flex-col sm:flex-row mid:flex-col gap-4">
                    ...
                    <div class="mid:pb-4 text-sm flex flex-col gap-2 items-start">
                        ...
                        <div class="pt-2 mt-auto ml-auto">
                            <button @click="$wire.startTransaction()"
                                class="w-24 px-2 py-1 text-xs md:text-sm enabled:bg-[#014421] enabled:hover:bg-green-800 enabled:text-white rounded-md disabled:bg-gray-300 disabled:cursor-not-allowed disabled:opacity-50"
