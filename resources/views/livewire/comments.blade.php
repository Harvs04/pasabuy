<div x-data="{ usersShow: false, liked: {{ collect($user->like_posts)->pluck('post_id')->contains($post->id) ? 'true' : 'false' }}, saved: {{ collect($user->save_posts)->pluck('post_id')->contains($post->id) ? 'true' : 'false' }} }">
