     ...
     @click.outside="if (openBurger && window.innerWidth < 1024) { openBurger = false; }">
      <div class="h-full px-3 pb-4 overflow-y-auto">
         <ul class="space-y-2 text-[15px]">
            ...
            <li>
               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg {{ Request::routeIs('dashboard') ? 'bg-gray-100' : 'hover:bg-gray-100 group hover:font-medium' }}">
            ...
            <li>
               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg {{ Request::routeIs('messages') ? 'bg-gray-100' : 'hover:bg-gray-100 group hover:font-medium' }}">
            ...
            @if($user->role === 'customer')
               <li>
                  <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg {{ Request::routeIs('saved') ? 'bg-gray-100' : 'hover:bg-gray-100 group hover:font-medium' }}">
               ...
               <li>
               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg {{ Request::routeIs('my-orders') ? 'bg-gray-100' : 'hover:bg-gray-100 group hover:font-medium' }}">
            ...
            @elseif($user->role === 'provider')
               <li>
                  <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg {{ Request::routeIs('transactions') ? 'bg-gray-100' : 'hover:bg-gray-100 group hover:font-medium' }}">
               ...
               <li>
                  <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg {{ Request::routeIs('deliveries') ? 'bg-gray-100' : 'hover:bg-gray-100 group hover:font-medium' }}">
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 {{ Request::routeIs('deliveries') ? 'text-gray-900' : '' }}">
                        <path d="M3.375 4.5C2.339 4.5 1.5 5.34 1.5 6.375V13.5h12V6.375c0-1.036-.84-1.875-1.875-1.875h-8.25ZM13.5 15h-12v2.625c0 1.035.84 1.875 1.875 1.875h.375a3 3 0 1 1 6 0h3a.75.75 0 0 0 .75-.75V15Z" />
                        <path d="M8.25 19.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0ZM15.75 6.75a.75.75 0 0 0-.75.75v11.25c0 .087.015.17.042.248a3 3 0 0 1 5.958.464c.853-.175 1.522-.935 1.464-1.883a18.659 18.659 0 0 0-3.732-10.104 1.837 1.837 0 0 0-1.47-.725H15.75Z" />
                        <path d="M19.5 19.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0Z" />
                     </svg>
                     <span class="ms-3 {{ Request::routeIs('deliveries') ? 'font-medium' : '' }}">Deliveries</span>
                  </a>
               </li>
               @endif
            <li>
               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg {{ Request::routeIs('pasabuy-history') ? 'bg-gray-100' : 'hover:bg-gray-100 group hover:font-medium' }}">
