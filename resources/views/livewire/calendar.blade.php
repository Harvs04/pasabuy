<div class="mt-3">
    <div x-data="app()" x-init="[initDate(), getNoOfDays(), $watch('datepickerValue', value => $dispatch('date-change', value))]" x-cloak>
    <div class="container mx-auto">
        <div class="w-full">
        <label for="datepicker" class="font-bold mb-1 text-gray-700 block" x-text="label"></label>
        <div class="relative">
            <input type="hidden"
                :name="name"
                x-ref="date"
            ...
            />
            <input type="text"
                class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:border-[#014421]" 
            ...
            <div class="absolute top-0 left-0 px-3 py-2">
                <svg class="h-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" >
            ...
            <div class="bg-white mt-12 rounded-lg shadow p-4 absolute bottom-0 left-0"
                style="width: 17rem;"
            ...
            <div class="flex justify-between items-center mb-2">
                <div>
                    <span class="text-lg font-bold text-gray-800" x-text="MONTH_NAMES[month]"></span>
                    <span class="ml-1 text-lg text-gray-600 font-normal" x-text="year"></span>
                </div>
                <div>
    ...
    function app({ value, label, name } = { value: new Date, label: '', name: 'date_input' }) {
