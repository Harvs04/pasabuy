<div class="bg-white px-4 pt-6 pb-4 sm:px-8 rounded-lg w-11/12 lg:w-2/3 xl:w-1/2 font-poppins relative">
    <div wire:loading.delay wire:target="createPost"  class="fixed inset-0 bg-white bg-opacity-50 z-[51] flex items-center justify-center">
    ...
    <div class="">
        <div class="flex flex-col">
            <div class="flex flex-row items-center gap-2 sm:gap-3">
                ...
                <button @click="createPostModalOpen = false; document.body.style.overflow = 'auto';" class="absolute top-4 right-4 p-2 hover:bg-gray-100 hover:rounded-full">
