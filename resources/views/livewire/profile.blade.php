            ...
            <div class="w-full sm:w-5/6 flex flex-col lg:flex-row gap-4">
                ...
                <div class="flex flex-col gap-4">
                    <div class="flex flex-row items-center lg:items-start xl:items-center gap-3">
                        <a href={{ route('dashboard') }}>
                            <svg class="w-6 hover:bg-gray-200 hover:rounded-full mt-0 lg:mt-1 xl:mt-0"
                    ...
                    <div class="rounded-md bg-white shadow w-full p-4">
                        <div class="w-full flex flex-col xl:flex-row justify-start items-center gap-4">
                            ...
                            <div class="flex flex-col justify-center items-center xl:items-start">
                                <p class="text-xl lg:text-base xl:text-lg font-medium md:font-semibold break-words">
                                    {{ $user->name }} </p>
                            ...
                            <div class="bg-white p-6 rounded-lg w-5/6 md:w-1/2 lg:w-1/3 relative">
                                <div class="flex flex-col items-center gap-2 sm:gap-3">
                                    ...
                                    <p class="text-xs sm:text-sm text-gray-600 self-start">To confirm this action, type
                                        "CONFIRM"</p>
                                    <input type="text" id="name" x-model="confirm"
                ...
                <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col py-6 px-8 justify-center"
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <button @click="isModalOpen = true; document.body.style.overflow = 'hidden';"
                                    class="ml-auto py-1 px-3 bg-[#014421] hover:bg-green-800 text-white text-sm rounded-md">
                                    Change role </button>
                            </div>
                  ...
                  " @click="
                              ...
                              " class="w-full md:w-1/6 h-12 bg-[#014421] rounded-md text-white hover:bg-green-800 flex items-center justify-center">Save
                                    changes</button>
                            </div>
                                ...
                                <div class="flex flex-col w-full mt-4">
                                    ...
                                    <div class="relative w-full">
                                        <input :type="showNewPassword ? 'text' : 'password'" id="new_password"
                                            ...
                                            class="w-11/12 bg-gray-50 border pe-10 border-gray-300 text-gray-700 text-sm rounded-lg focus:outline-none focus:border-[#014421] block p-2.5"
                                            {{ $user->google_id == '' ? '' : "disabled" }}
                            ...
                            <div class="flex flex-col sm:flex-row mt-4">
                                ...
                                <div class="flex flex-col w-full">
                                    ...
                                    <input type="password" id="new_password"
                                        class="hidden w-11/12 bg-gray-50 border border-gray-300 text-gray-700 text-sm rounded-lg focus:outline-none focus:border-[#014421] p-2.5"
