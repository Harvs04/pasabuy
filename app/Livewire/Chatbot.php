...
class Chatbot extends Component
{
    ...
    public $action_answers = [
        ...
        'transactions' => ['To view a specific transaction, click the \'View\' button or the eye icon in the list of transactions.0', 'To start a transaction, you may use one of the following choices: (1) \'Start\' button in the list of transactions, (2) start option found when you click the triple dots on top of a transaction\'s details, or (3) using the start option in the page of a specific order.0', 'You can update the status of an either via the \'Acquire\', \'Deliver\', and \'Cancel\'  buttons found in the list of orders or in the page of each order.0'],
